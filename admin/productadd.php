    ...
    <div class="product-add-content">
        ...
        <form action="productadd.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="sanpham-size">
                <p>36</p> <input type="checkbox" name="sanpham-size[]" value="36">
                <p>37</p> <input type="checkbox" name="sanpham-size[]" value="37">
                ...
                <p>43</p> <input type="checkbox" name="sanpham-size[]" value="43">
                <p>44</p> <input type="checkbox" name="sanpham-size[]" value="44">
            </div>

            ...
            <div class="cart-content-left">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <p><?php $resultC = number_format($result['sanpham_gia']); echo $resultC ?><sup>đ</sup></p>
                        </td>
            ...
            <div class="cart-content-right">
                <table>
                    ...
                    <tr>
                        <td>THÀNH TIỀN</td>
                        <td>
                            <p><?php $resultD = number_format($TT); echo $resultD;Session::set('TT',$resultD); ?><sup>đ</sup>
                            </p>
                        </td>
                    </tr>
                    <tr>
                ...
                <div class="cart-content-right-text">
                    ...
                    <p style="color: red;font-weight: bold;">Mua thêm <span
                            style="font-size: 18px;"><?php $them = 2000000 - $TT; $resultC = number_format($them); echo $resultC  ?><sup>đ</sup></span>
                        để được miễn phí SHIP</p>
                    <?php
                        }
                        ?>
                </div>

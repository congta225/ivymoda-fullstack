            ...
            <div class="delivery-content-left">
                <form action="" method="post">
                    ...
                    <div class="delivery-content-left-dangnhap row">
                        ...
                        <p>Đăng nhập (Nếu bạn đã có tài khoản của SnksDunk)</p>
                    </div>
                    <br>
                    ...
                    <br>
                    <input style="float: left;margin-right:12px" class="register-input" name="loaikhach" value="dangky"
                        type="radio">
                    ...
                    <div class="delivery-content-left-input-top row">
                        ...
                        <div class="delivery-content-left-input-top-item">
                            ...
                            <select name="customer_tinh" id="tinh_tp"
                                ...
                                ?>
                                <option value="<?php echo $result['ma_tinh'] ?>"><?php echo $result['tinh_tp'] ?>
                                </option>
                                <?php
                                }}
                                ?>

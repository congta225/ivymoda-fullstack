        ...
        <div class="product-content row">
            ...
            <div class="product-content-right">
                ...
                <div class="product-content-right-product-price">
                    <p><span><?php $resultC = number_format($result['sanpham_gia']); echo $resultC ?></span><sup>đ</sup>
                    </p>
                    <input class="sanpham_gia" type="hidden" value="<?php echo $result['sanpham_gia'] ?>">
                </div>
                <!-- <div class="product-content-right-product-color">
                    <p><span style="font-weight: bold;">Màu sắc</span>:<?php echo $result['color_ten'] ?> <span
                ...
                <div class="product-content-right-product-size">
                    ...
                    <div class="size">
                        ...
                        ?>
                        <div class="size-item">
                            <input class="size-item-input" value="<?php echo $resultV['sanpham_size']?>"
        ...
        <div class="row justify-between">
            ...
            <div class="product-related-item">
                <a href="product.php?sanpham_id=<?php echo $resultZ['sanpham_id']?>"><img
                        src="admin/uploads/<?php echo $resultZ['sanpham_anh']?>" alt=""></a>
